...
public class RandomT {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String sql = """
                INSERT INTO random_transactions (
                    transaction_id, transaction_type, transaction_mode, amount, transaction_time,
                    sender_id, sender_account, sender_mobile, sender_device, sender_location,
                    sender_ip, auth_type,
                    receiver_id, receiver_account, receiver_mobile,
                    fraud_score, status, failure_reason, balance
                ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)
                """;
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                String transactionId = "TXN" + (1000000 + random.nextInt(900000));
                ...
                ps.setString(18, failureReason);
                ps.setDouble(19, balance);
